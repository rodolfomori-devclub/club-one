		...
		<div class=" flex max-w-full w-full mx-auto px-1.5 md:px-2 pt-0.5 bg-transparent">
			...
			"
				...
				<div class="self-start flex flex-none items-center text-gray-600 dark:text-gray-400">
					...
					<!-- ClubHub: toggle de tema visível também no embed (o usuário controla claro/escuro). -->
					<ThemeSelector />
					...
					{#if $user?.role === 'admin'}
						<!-- ClubHub: painel de Controls só para admin (membro comum não altera prompt/params) -->
